...
class VisiteController extends Controller
{
    ...
    {
        $visites = Visite::with(['personnel', 'typeVisite', 'raisonVisite', 'statut', 'visiteur'])
            ->orderBy('created_at', 'desc')  // Ajoutez cette ligne pour trier par date de création décroissante
            ->get();
    ...
    public function show($id)
    {
        ...
        return response()->json([
            'visite' => $visite->load(['visiteur', 'personnel', 'raisonVisite', 'typeVisite', 'statut'])
        ], 200);
    }
